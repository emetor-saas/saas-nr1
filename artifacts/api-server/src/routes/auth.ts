...
async function upsertUser(claims: Record<string, unknown>) {
  ...
  // Check if the user already exists — if so, just update profile fields
  // (never overwrite tenantId or role on subsequent logins).
  ...
  // New user: create a dedicated tenant for this account (full isolation).
  // Each company/user that signs up independently gets their own tenant.
